...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="surname" value="<?php echo e(old('surname')); ?>" 
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="nick" value="<?php echo e(old('nick')); ?>" required autocomplete="nick" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laravelapelo\LaravelSolo\resources\views/auth/register.blade.php ENDPATH**/ ?>