...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        {{-- Alerta cuando se modifique el user --}}
        @if(session('message'))
            <div class="alert alert-success">
                {{ session('message') }}
            </div>
        @endif
        {{-- carta metodo de bootstrap  --}}
        <div class="card">
                ...
                <form action="{{ route('user.update') }}" enctype="multipart/form-data"  method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            @error('surname') is-invalid @enderror" name="surname" value="{{ Auth::user()->surname }}" 
